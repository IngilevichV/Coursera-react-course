...
import {Breadcrumb, BreadcrumbItem, Button, Col, Label, Input, Row } from 'reactstrap';
...
const validEmail = (val) => /^(|(([A-Za-z0-9]+_+)|([A-Za-z0-9]+-+)|([A-Za-z0-9]+\.+)|([A-Za-z0-9]+\++))*[A-Za-z0-9]+@((\w+-+)|(\w+\.))*\w{1,63}\.[a-zA-Z]{2,6})$/.test(val);
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" type="textarea" id="message" name="message"
                                           ...
                                           className="form-control"
                                           validators={{required}}/>
                                    <Errors className="text-danger" model=".textarea" show="touched"
                                            messages ={{
                                                required: "Required"
                                            }}/>
                                </Col>
